                    ...
                    <fieldset>
                        <h2 class="fs-title">Secure your data by uploading it on Recordskeeper </h2>
                            ...
                            <div class="form leadform row">
                                <div class="col-md-6">
                                    <input type = "text" id="leadfirstname" name="leadfirstname" class="leadinputs " placeholder="Enter your Name ">
                                  
                                </div>
                                <div class="col-md-6">
                                    <input type = "email" id="leademail" name="leademail" class="leadinputs " placeholder = "Enter your email address">
                                </div>
